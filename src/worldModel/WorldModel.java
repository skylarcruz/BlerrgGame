...
public class WorldModel {
	...
	public WorldModel(int screenWidth, int screenHeight, BlerrgGame bg, ArrayList<Integer> c, int l) {
		...
		player = new Player(map.getRandomSpawnV(), 0, 0, c.get(0));
		...
		if (bg.clientCount >= 1 && bg.p2Active) {
			player2 = new Player(map.getRandomSpawnV(), 0, 0,c.get(1));
		...
		if (bg.clientCount >= 2 && bg.p3Active) {
			player3 = new Player(map.getRandomSpawnV(), 0, 0, c.get(2));
		...
		if (bg.clientCount == 3 && bg.p4Active) {
			player4 = new Player(map.getRandomSpawnV(), 0, 0, c.get(3));
