...
//		if (bg.clientCount >= 1)
//			bg.world.player2 = new Player(bg.ScreenWidth/2 + 50, bg.ScreenHeight/2, 0, 0, 0);
//		if (bg.clientCount >= 2)
//			bg.world.player3 = new Player(bg.ScreenWidth/2, bg.ScreenHeight/2 + 50, 0, 0, 0);
//		if (bg.clientCount == 3)
//			bg.world.player4 = new Player(bg.ScreenWidth/2 + 50, bg.ScreenHeight/2 + 50, 0, 0, 0);
//		
		//bg.createMap(0);
//>>>>>>> refs/heads/dev
	}
